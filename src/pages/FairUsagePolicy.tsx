      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="container px-4 py-16 max-w-3xl">
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4">3. Concurrent Players</h2>
              <div className="text-muted-foreground leading-relaxed">
                <p className="mb-4">Recommended concurrent player limits by plan:</p>
                <ul className="list-disc list-inside space-y-2">
                ...
                <p className="mt-4">These are guidelines, not hard limits. Occasional spikes are expected during recordings or events.</p>
              </div>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4">4. Storage Usage</h2>
              <div className="text-muted-foreground leading-relaxed">
                <p className="mb-4">Fair usage storage allocations:</p>
                <ul className="list-disc list-inside space-y-2">
                ...
                <p className="mt-4">If you're approaching limits, we'll reach out to discuss options—not cut you off.</p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-muted-foreground leading-relaxed">
                <p className="mb-4">The following uses are not permitted:</p>
                <ul className="list-disc list-inside space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4">6. Resource-Intensive Activities</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4">7. Policy Enforcement</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4">8. Questions</h2>
              <p className="text-muted-foreground leading-relaxed">
                If you're unsure whether your intended use falls within this policy, please contact us at support@stratustechgroup.com before signing up. We're happy to clarify.
              </p>
            </section>
          </div>
        </main>
